# Ride height
Create a program that prompts the user for their height to determine if the person is tall enough to ride. Print the appropriate message.

Sample Output:
```
You must be at least 55 inches tall to ride
...
For safety reasons, we can't let you ride yet.
```
