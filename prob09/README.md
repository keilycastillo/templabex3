# Movies Date Night Deals
It's date night at the movies! Tickets tonight are discounted, the only condition is that tickets can
only be bought in pairs
Create a program that computes the subtotal for the ticket cost for a pair of tickets.
The program should ask the user for the age of the first and second guest.

However, there are different pricing structures based on the guest's age.

*Children tickets cost $10*

*Young Adult tickets cost $13*

*Adult tickets cost $15*

*Senior tickets cost $10*

This pricing list should be displayed to the user, just as it is below.

```
Welcome to date night at the  Movies!
